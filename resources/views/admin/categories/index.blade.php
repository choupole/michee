            ...
            <div class="col-md-6 col-sm-12 text-right">
                <div class="dropdown">
                    ...
                    <a href="#" class="btn  btn-outline-primary" data-toggle="modal" data-target="#Medium-modal" type="button">
                        {{-- <img src="vendors/images/modal-img2.jpg" alt="modal"> --}}New category
                    </a>
        ...
        <div class="pb-20">
            <table class="table hover data-table-export nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="table-plus"> {{$category->CodCat}} </td>
                        <td> {{$category->LibCat}} </td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    <a class="dropdown-item" href="{{ route('categories.show', $category->CodCat) }}"><i class="dw dw-eye"></i> View</a>
                                    @csrf
                                    @method('DELETE')
                                    <a class="dropdown-item" href="{{ route('categories.destroy',$category->CodCat) }}" onclick="supprimer(event)" item="Voulez-vous supprimer la category {{ $category->LibCat }}" data-toggle="modal" data-target="#supprimer">
